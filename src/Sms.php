...
class Sms
{
    ...
    private const API_BASE_URL = 'http://sms1.mailmantra.com/v2/api';
    ...
    public function send($to, $message, $dlt_te_id, $extras = []): array
    {
        ...
        try {
            ...
            //API URL
            $url = self::API_BASE_URL."/send_sms";
    ...
    public function sendBulk($sms, $dlt_te_id, $extras = []):array
    {
        $result = [];
        ...
        try {
            ...
            */
            ...
            $url = self::API_BASE_URL."/send_sms_v2";
